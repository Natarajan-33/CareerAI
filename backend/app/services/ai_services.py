...
def generate_domain_suggestion(passion: str, strengths: str) -> str:
    ...
    Args:
        passion (str): User's passion/interests
        strengths (str): User's strengths/skills
        
    Returns:
        str: AI-generated domain suggestion
    """
    prompt = f"""
...
def generate_social_media_post(project_title: str, domain: str, tasks_completed: str, progress_percentage: int) -> str:
    ...
    Args:
        ...
        domain (str): Domain of the project
        tasks_completed (str): Description of completed tasks
        progress_percentage (int): Percentage of project completion
        
    Returns:
        str: AI-generated social media post
    """
    prompt = f"""
