...
import { IkigaiResult } from '../../stores/IkigaiStore';
...
const IkigaiResults: React.FC<IkigaiResultsProps> = observer(({ result, onReset }) => {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-10 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-2">{result.aiSuggestion}</h3>
            ...
            <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="px-2 py-1 text-sm rounded-full bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200">
                  {Math.round(domain.matchScore * 100)}% Match
                </span>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {domain.requiredSkills.map((skill, i) => (
