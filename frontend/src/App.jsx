...
import { DomainSelectionPage, ProjectsPage, ProgressPage } from './modules/journey';
...
// Primary pages
// JourneyPage component is defined inline since it's not in the modules directory
const JourneyPage = () => (
...
// Using the singleton rootStore instance from the stores/index.js file
